                            ...
                            {activeTab === 'preprocessing' && (
                                <motion.div variants={containerStaggerVariants}>
                                    ...
                                    <ListContainer variants={containerStaggerVariants}>
                                        <ListItem variants={itemFadeUpVariants}>Image format conversion (to RGB).</ListItem>
                                        <ListItem variants={itemFadeUpVariants}>Resizing to standard <Code variants={codeVariants} whileHover="hover" whileTap="tap">224x224</Code> pixels.</ListItem>
                                        <ListItem variants={itemFadeUpVariants}>Normalization using ImageNet statistics.</ListItem>
                                        ...
                                        <ListItem variants={itemFadeUpVariants}>Training-time data augmentation (rotations, flips, etc.).</ListItem>
                                    </ListContainer>
                                    <Text as={motion.p} variants={itemFadeUpVariants}> This ensures consistency and improves model robustness. </Text>
                                </motion.div>
                            )}
                            {activeTab === 'output' && (
                                <motion.div variants={containerStaggerVariants}>
                ...
                {activeTab === 'architecture' && (
                    <motion.div variants={containerStaggerVariants} initial="hidden" animate="visible">
                        ...
                        <ModelSection variants={itemFadeUpVariants} whileHover={{ y: -5 }}>
                            ...
                            <ListContainer variants={containerStaggerVariants}>
                                <ListItem variants={itemFadeUpVariants}> Overall accuracy: <Code variants={codeVariants} whileHover="hover" whileTap="tap">94.7%</Code> on validation data </ListItem>
                                <ListItem variants={itemFadeUpVariants}> Sensitivity: <Code variants={codeVariants} whileHover="hover" whileTap="tap">92.1%</Code> for pneumonia, <Code variants={codeVariants} whileHover="hover" whileTap="tap">91.8%</Code> for tuberculosis </ListItem>
                                <ListItem variants={itemFadeUpVariants}> Specificity: <Code variants={codeVariants} whileHover="hover" whileTap="tap">95.3%</Code> for pneumonia, <Code variants={codeVariants} whileHover="hover" whileTap="tap">96.9%</Code> for tuberculosis </ListItem>
                                <ListItem variants={itemFadeUpVariants}> F1 Score: <Code variants={codeVariants} whileHover="hover" whileTap="tap">0.933</Code> across all categories </ListItem>
                            </ListContainer>
                        </ModelSection>
                        ...
                        <DatasetSection variants={itemFadeUpVariants} whileHover={{ y: -5 }}>
                            ...
                            <Text as={motion.p} variants={itemFadeUpVariants}> Trained on over 15,000 diverse, anonymized chest X-rays from public and clinical sources, ensuring category balance and attention to bias mitigation. </Text>
                            <SubHeading as="h3" variants={subHeadingVariants} whileHover="hover">Data Privacy & Ethics</SubHeading>
